        ...
        <div className="max-h-[550px]">
          ...
          <div className="absolute bottom-0 left-0 w-full h-full bg-gradient-to-b from-[#06646601] to-[#066466c5] rounded">
            <div className=" absolute bottom-20 left-[10%] text-center w-5/6 mx-auto text-white   ">
              ...
              <br /><span>The limits of my language are the limits of my world.</span>
              </h4>
        ...
        <div className="max-h-[550px]">
          ...
          <div className="absolute bottom-0 left-0 w-full h-full bg-gradient-to-b from-[#06646601] to-[#066466c5] rounded">
            <div className=" absolute bottom-20 left-[10%] text-center w-5/6 mx-auto text-white   ">
              ...
              <br /><span>Learning is experience. Everything else is information. </span>
              </h4>
              <p className="text-gray-200">
        ...
        <div className="max-h-[550px]">
          ...
          <div className="absolute bottom-0 left-0 w-full h-full bg-gradient-to-b from-[#06646601] to-[#066466c5] rounded">
            <div className=" absolute bottom-20 left-[10%] text-center w-5/6 mx-auto text-white   ">
              ...
              <br /><span>Studying is like climbing a mountain.</span>
              </h4>
              <p className="text-gray-200">
        ...
        <div className="max-h-[550px]">
          ...
          <div className="absolute bottom-0 left-0 w-full h-full bg-gradient-to-b from-[#06646601] to-[#066466c5] rounded">
            <div className=" absolute bottom-20 left-[10%] text-center w-5/6 mx-auto text-white   ">
              ...
              <br /><span>To have another language is to possess a second soul.</span>
              </h4>
              <p className="text-gray-200">
