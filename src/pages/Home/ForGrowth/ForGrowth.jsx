      ...
      <div className="w-11/12 md:w-10/12 mx-auto">
        ...
        <div className="md:grid grid-cols-4 gap-5 px-5 py-14 my-14 text-white rounded-md bg-gradient-to-r from-[#066466] to-[#03dee2]">
          ...
          <div data-aos="fade-up"
            data-aos-duration="1200" className="flex items-start justify-between gap-5">
            <div className="p-2 bg-[#066466] rounded-lg">
          ...
          <div data-aos="fade-up"
            data-aos-duration="1500" className="flex items-start justify-between gap-5">
            <div className="p-2 bg-[#066466] rounded-lg">
          ...
          <div data-aos="fade-up"
            data-aos-duration="2000" className="flex items-start justify-between gap-5">
            <div className="p-2 bg-[#066466] rounded-lg">
            ...
            <div>
              ...
              <p className="text-gray-300">
                Now you are ready to go, to explore the tradition and culture of
                the world.
              </p>
            </div>
          </div>
