...
const Header = () => {
  ...
  return (
    <>
      <div className="bg-[#066466]">
        <div className=" w-11/12 md:w-10/12 mx-auto navbar text-white">
          ...
          <div className="navbar-end">
            ...
            {/* Dashboard, Login and Logout Section */}
            {user && (
              <>
                <Link to={"/dashboard"} className="font-semibold me-3">
                  Dashboard
                </Link>
              </>
            )}
